    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          {/* Filter Tabs */}
          <div className="flex space-x-1 bg-gray-100 dark:bg-gray-700 rounded-lg p-1 mt-3">
            {[
              { key: 'all', label: 'All' },
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {notification.type === 'loan_rejected' && notification.metadata?.reason && (
                          <div className="bg-red-100 dark:bg-red-900/20 rounded-lg p-2 mb-2">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            ...
                            className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 text-xs font-medium flex items-center space-x-1"
                          >
            ...
            <div className="space-y-4">
              ...
              {selectedNotification.metadata && (
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  <h5 className="font-medium text-gray-900 dark:text-white mb-3 text-sm">Additional Information</h5>
